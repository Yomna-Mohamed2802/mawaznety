...
const Login = () => {
  ...
  }, [loginWithGoogle, navigate, GOOGLE_CLIENT_ID, agreeTerms]);
            ...
            <>
              ...
              <p className="text-center text-xs text-primary-500 mt-6">
                {isRegister ? (
                  <>
                    لديك حساب بالفعل؟{' '}
                    <button onClick={() => { setIsRegister(false); setError(''); }} className="underline text-primary-600 hover:text-primary-800">تسجيل الدخول</button>
                  </>
                ) : (
                  <>
                    ليس لديك حساب؟{' '}
                    <button onClick={() => { setIsRegister(true); setError(''); }} className="underline text-primary-600 hover:text-primary-800">إنشاء حساب جديد</button>
                  </>
                )}
              </p>
            </>
