            ...
            <>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-white px-3 text-primary-400">{t.or}</span>
                </div>
              </div>
              ...
              <p className="text-center text-xs text-primary-500 mt-6">
                {isRegister ? (
                  <>
                    {t.hasAccount}{' '}
                    <button onClick={() => { setIsRegister(false); setError(''); setSuccess(''); }} className="underline text-primary-600 hover:text-primary-800">{t.loginBtn}</button>
                  </>
                ) : (
                  <>
                    {t.noAccount}{' '}
                    <button onClick={() => { setIsRegister(true); setError(''); setSuccess(''); }} className="underline text-primary-600 hover:text-primary-800">{t.registerBtn}</button>
                  </>
                )}
              </p>
            </>
