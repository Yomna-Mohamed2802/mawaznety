          ...
          <div className="prose prose-primary space-y-6 text-primary-700 leading-relaxed">
            <section>
              ...
              <p className="mt-2 text-sm bg-amber-50 border border-amber-200/60 rounded-xl p-3">
                <strong>تنبيه:</strong> موازنتي مشروع تعليمي مستقل وليس تابعاً لأي جهة حكومية رسمية. البيانات المعروضة مأخوذة من موازنة المواطن الرسمية للأغراض التعليمية فقط.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 mr-4">
                ...
                <li>لا نشارك بياناتك لأطراف ثالثة إلا إذا وافقت على ذلك</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>نتخذ إجراءات أمنية مناسبة لحماية بياناتك الشخصية من الوصول غير المصرح به أو التعديل أو الإفصاح أو الإتلاف. مع ذلك، لا توجد طريقة نقل عبر الإنترنت آمنة بنسبة ١٠٠٪.</p>
            </section>
