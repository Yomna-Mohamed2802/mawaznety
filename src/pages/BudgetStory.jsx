...
const T = {
  ar: {
    badge: 'موازنة المواطن 2026/2027',
    title1: 'حكاية',
    ...
    ch5p3: 'بعدها بيجي الدعم والحماية الاجتماعية (١٦.١ جنيه) — وده بيشمل دعم السلع التموينية والكهرباء والإسكان. وبعدها الأجور والرواتب (١٥.٩ جنيه).',
    ...
    ch6p1: 'الدين العام هو إجمالي الفلوس اللي الدولة مقترضتها من بنوك ومؤسسات مالية مصرية ودولية.',
    ...
    ch7p3: 'بس الخبر الحسن: النسبة دي بتقل. كانت ٧٣% ونقصت لـ ٦٠%.',
    ...
    ch10stat1: '١,٢٢٩.٧ مليار', ch10label1: 'ميزانية التعليم', ch10sub1: '٦٪ من الناتج المحلي',
    ...
    ch11stat1: '٨٦٢.٩ مليار', ch11label1: 'ميزانية الصحة', ch11sub1: '٤.٢٪ من الناتج المحلي',
