...
const T = {
  ar: {
    ...
    ch1p1: 'الموازنة هي <strong>خطة الدولة المالية لمدة سنة</strong>. بتحدد الدولة هتجيب فلوس منين (الإيرادات) وهتها فين (المصروفات).',
    ...
    ch1p3: 'مصر بتعمل الموازنة بتاعتها كل سنة وبتقدمها للبرلمان للمناقشة والتصويت. الموازنة دي مش مجرد أرقام — هي <strong>قرارات بتأثر على حياتك كل يوم</strong>: تعليمك، صحتك، شوارعك، ومستقبلك.',
    ch1tip: 'معلومة مهمة',
    ...
    ch2p2: 'يعني الدولة بتصرف أكتر مما بتجيب بحوالي ١.١٣ تريليون جنيه. الفرق ده اسمه <strong>العجز النقدي</strong> وبيمثل ٤.٦% من الناتج المحلي.',
    ch2p3: 'بس لو شلنا فوائد الدين من المعادلة، هنلاقي إن الدولة عندها <strong>فائض أولي</strong> بقيمة ١.٢٢ تريليون جنيه (٥% من الناتج المحلي). يعني الإيرادات كفاية تغطي كل المصروفات ما عدا فوائد الدين.',
    ch2tip: 'يعني إيه فائض أولي؟',
    ch2tipText: 'الفائض الأولي هو الفرق بين الإيرادات والمصروفات <strong>قبل</strong> دفع فوائد الدين. لو الفائض إيجابي، ده معناه إن الدولة بتجيب أكتر مما بتصرف في خدماتها ومشاريعها — المشكلة بس في فوائد الدين.',
    ch3Title: 'الناتج المحلي — قوة الاقتصاد',
    ch3p1: 'الناتج المحلي الإجمالي (GDP) هو <strong>قيمة كل البضائع والخدمات اللي انتجتها الدولة في سنة</strong>. هو المقياس الرئيسي لقوة الاقتصاد.',
    ...
    ch5p2: 'أكبر بند في المصروفات هو <strong>فوائد الدين</strong> — ٤٦.٦ جنيه من كل ١٠٠ جنيه. يعني تقريبًا نص الفلوس بتروح لسداد فوائد القروض.',
    ch5p3: 'بعدها comes <strong>الدعم والحماية الاجتماعية</strong> (١٦.١ جنيه) — وده بيشمل دعم السلع التموينية والكهرباء والإسكان. وبعدها <strong>الأجور والرواتب</strong> (١٥.٩ جنيه).',
    ...
    ch6p1: 'الدين العام هو <strong>إجمالي الفلوس اللي الدولة مقترضتها</strong> من بنوك وم figureات مالية مصرية ودولية.',
    ...
    ch7p1: 'فوائد الدين هي <strong>التكلفة اللي الدولة بتدفعها عشان القروض</strong>. زي لما بتاخد قرض من البنك وبتدفع عليه فائدة.',
    ...
    ch8p1: 'الدولة بتنفق ٨٣٦.٨ مليار جنيه على <strong>الدعم والحماية الاجتماعية</strong>.',
    ...
    ch9p1: 'الدولة بتصرف ٨٢٢.٨ مليار جنيه على <strong>الأجور والرواتب</strong>.',
    ...
    ch10p1: 'مصر بتصرف ١,٢٢٩.٧ مليار جنيه على التعليم — وده <strong>٦% من الناتج المحلي</strong>.',
    ...
    ch11p1: 'مصر بتصرف ٨٦٢.٩ مليار جنيه على الصحة — وده <strong>٤.٢% من الناتج المحلي</strong>.',
    ...
    ch12p1: 'الدولة بتستثمر ٥٥٣.٧ مليار جنيه في <strong>مشاريع استثمارية</strong>.',
    ...
    ch13p1: 'مشروع "حياة كريمة" هو أكبر مشروع تنموي في مصر — <strong>١ تريليون جنيه</strong> على ٣ مراحل.',
    ...
    ch14p1: 'الدولة بتصرف ٩٠ مليار جنيه في <strong>برامج اقتصادية</strong> لدعم الشركات والمصانع والصادرات.',
    ...
    ch16p2: 'الموازنة مش شيء بعيد عنك — هي <strong>قرارات بتأثر على حياتك كل يوم</strong>.',
  ...
  en: {
    ...
    ch1p1: 'The budget is the <strong>state\'s financial plan for one year</strong>. It determines where the state gets its money (revenues) and where it spends it (expenditures).',
    ...
    ch1p3: 'Egypt prepares its budget every year and presents it to parliament for discussion and voting. This budget isn\'t just numbers — it\'s <strong>decisions that affect your life every day</strong>: your education, health, streets, and future.',
    ...
    ch2p2: 'The state spends about 1.13 trillion EGP more than it earns. This gap is called the <strong>cash deficit</strong> and represents 4.6% of GDP.',
    ch2p3: 'But if we remove debt interest from the equation, the state has a <strong>primary surplus</strong> of 1.22 trillion EGP (5% of GDP). This means revenues cover all expenditures except debt interest.',
    ch2tip: 'What is a Primary Surplus?',
    ch2tipText: 'The primary surplus is the difference between revenues and expenditures <strong>before</strong> paying debt interest. A positive surplus means the state earns more than it spends on services and projects — the issue is only with debt interest.',
    ch3Title: 'GDP — The Economy\'s Strength',
    ch3p1: 'Gross Domestic Product (GDP) is the <strong>value of all goods and services produced by the state in one year</strong>. It\'s the primary measure of economic strength.',
    ...
    ch5p2: 'The largest item in expenditures is <strong>debt interest</strong> — 46.6 pounds out of every 100. This means nearly half the money goes to paying loan interest.',
    ch5p3: 'Next comes <strong>subsidies & social protection</strong> (16.1 pounds) — covering food subsidies, electricity, and housing. Then <strong>wages & salaries</strong> (15.9 pounds).',
    ...
    ch6p1: 'Public debt is the <strong>total money the state has borrowed</strong> from banks and financial institutions, both Egyptian and international.',
    ...
    ch7p1: 'Debt interest is the <strong>cost the state pays for loans</strong>. Like when you take a bank loan and pay interest on it.',
    ...
    ch8p1: 'The state spends 836.8 billion EGP on <strong>subsidies and social protection</strong>.',
    ...
    ch9p1: 'The state spends 822.8 billion EGP on <strong>wages and salaries</strong>.',
    ...
    ch10p1: 'Egypt spends 1,229.7 billion EGP on education — that\'s <strong>6% of GDP</strong>.',
    ...
    ch11p1: 'Egypt spends 862.9 billion EGP on health — that\'s <strong>4.2% of GDP</strong>.',
    ...
    ch12p1: 'The state invests 553.7 billion EGP in <strong>investment projects</strong>.',
    ...
    ch13p1: 'The "Decent Life" initiative is Egypt\'s largest development project — <strong>1 trillion EGP</strong> across 3 phases.',
    ...
    ch14p1: 'The state spends 90 billion EGP on <strong>economic programs</strong> to support companies, factories, and exports.',
    ...
    ch16p2: 'The budget isn\'t something far from you — it\'s <strong>decisions that affect your life every day</strong>.',
...
function Chapter({ num, title, children, chapterLabel }) {
  return (
    <Section className="mb-16">
      ...
      <div className="text-primary-600 leading-[1.9] space-y-4 text-[15px]" dangerouslySetInnerHTML={{ __html: children }} />
    </Section>
  );
}
...
function TipBox({ title, children }) {
  return (
    <div className="bg-amber-50 border border-amber-200/60 rounded-xl p-5 mt-4">
      ...
      <p className="text-sm text-primary-600" dangerouslySetInnerHTML={{ __html: children }} />
    </div>
  );
}
