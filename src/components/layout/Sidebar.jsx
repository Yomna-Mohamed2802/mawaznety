  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed right-0 top-0 h-full w-64 bg-white border-l border-primary-100/60 z-50 lg:translate-x-0 flex flex-col"
        style={{ transform: isOpen ? 'translateX(0)' : 'translateX(100%)', boxShadow: '0 0 30px -10px rgb(16 42 67 / 0.06)' }}
      >
        {/* Logo */}
        <div className="px-5 py-5 border-b border-primary-100/60">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-primary-700 to-primary-900 rounded-xl flex items-center justify-center" style={{ boxShadow: '0 2px 8px -2px rgb(16 42 67 / 0.3)' }}>
            ...
            {menuItems.map((item) => {
              ...
              return (
                <li key={item.path}>
                  <NavLink
                    to={item.path}
                    className={`relative flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 text-sm ${
                      isActive
        ...
        <div className="p-3 border-t border-primary-100/60">
          <div className="bg-gradient-to-l from-primary-50 to-surface-warm rounded-xl p-3.5 border border-primary-100/40">
            ...
            <p className="text-xs text-primary-500 mt-0.5">مسابقة 2024</p>
          </div>
        </div>
      </motion.aside>
    </>
